...
import AuthenticatorInputForm from 'widgets/Authenticator/AuthenticatorInputForm/AuthenticatorInputForm'
import TestemonialGallery from 'widgets/TestemonialGallery/TestemonialGallery'

const AuthenticateCodePage = (): any => {
  return (
    <Box
      sx={{
        display: 'flex',
